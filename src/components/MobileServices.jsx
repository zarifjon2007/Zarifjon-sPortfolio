  ...
  return (
    <>
            <div id='mservices' className=' container mx-auto text-white mt-8 w-[95%]'>
                <div className=" ">
                    <h1 className="font-bold text-center text-3xl boder border-l-2 border-r-2  border-purple-500  mx-auto w-[100%]">My Services</h1>
                    <div className=" w-full  mx-auto h-auto overflow-hidden rounded-xl border border-2 border-purple-600 mt-10 cursor-pointer">
                        ...
                        <div className=" w-90 p-3 ">
                            <h1 className=" text-3xl font-semibold mb-5 ">🌐 Web Development</h1>
                            <p className="text-xl">
                     ...
                     <div className=" w-full  mx-auto h-auto overflow-hidden rounded-xl border border-2 border-purple-600 mt-10 cursor-pointer">
                        ...
                        <div className="p-3">
                            <h1 className=" text-3xl font-semibold mb-5">🌐 Frontend Development</h1>
                            <p className="text-xl">
